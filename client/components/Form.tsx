            ...
            <div className="doodle-card-inner">
              <div className="doodle-card-front">
               ...
               <form className="doodle-form" onSubmit={handleSubmit}>
                  ...
                  <button className="doodle-btn">Let&apos;s Go!</button>
                </form>
              </div>
              <div className="doodle-card-back">
               ...
               <form className="doodle-form" onSubmit={handleSubmit}>
                  ...
                  <button className="doodle-btn doodle-btn-alt">
                    Confirm!
                  </button>
                </form>
              </div>
...
const StyledWrapper = styled.div`
  .doodle-wrapper {
    ...
    font-family:
      "Comic Sans MS", "Chalkboard SE", "Marker Felt", "Gochi Hand", sans-serif;
    display: flex;
